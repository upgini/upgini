...
def test_norm():
    ...
    for c in data.columns:
        ...
        assert_series_equal(operand.calculate(data=data[c]), expected_result[c])
    ...
    for c in transform_data.columns:
        ...
        assert_series_equal(operand.calculate(data=transform_data[c]), expected_transform_result[c])

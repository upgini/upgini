...
def test_default_metric_binary(requests_mock: Mocker):
    ...
    print(metrics_df)
    assert metrics_df.loc["train", "baseline roc_auc"] == pytest.approx(0.499840, abs=0.000001)  # type: ignore
    assert metrics_df.loc["train", "enriched roc_auc"] == pytest.approx(0.507203, abs=0.000001)  # type: ignore
    assert metrics_df.loc["train", "uplift"] == pytest.approx(0.007363, abs=0.000001)  # type: ignore

    assert metrics_df.loc["eval 1", "baseline roc_auc"] == pytest.approx(0.461921, abs=0.000001)  # type: ignore
    assert metrics_df.loc["eval 1", "enriched roc_auc"] == pytest.approx(0.466604, abs=0.000001)  # type: ignore
    assert metrics_df.loc["eval 1", "uplift"] == pytest.approx(0.004683, abs=0.000001)  # type: ignore

    assert metrics_df.loc["eval 2", "baseline roc_auc"] == pytest.approx(0.499839, abs=0.000001)  # type: ignore
    assert metrics_df.loc["eval 2", "enriched roc_auc"] == pytest.approx(0.493792, abs=0.000001)  # type: ignore
    assert metrics_df.loc["eval 2", "uplift"] == pytest.approx(-0.006047, abs=0.000001)  # type: ignore
